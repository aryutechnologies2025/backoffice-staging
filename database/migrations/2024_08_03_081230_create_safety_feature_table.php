...
return new class extends Migration
{
    ...
    {
        Schema::create('safety_feature', function (Blueprint $table) {
            $table->integer('id', true); // Creates 'id' column with auto-increment
            $table->string('safety_features', 150); // Creates 'safety_features' column
    ...
    {
        Schema::dropIfExists('safety_feature');
    }
};
