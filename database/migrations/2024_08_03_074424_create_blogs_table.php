...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('blogs', function (Blueprint $table) {
            ...
            $table->string('blog_title', 150); // Creates 'blog_title' column
            $table->longText('description'); // Creates 'description' column
            $table->string('blog_pic_1', 150)->nullable(); // Creates 'blog_pic_1' column, nullable
            $table->string('blog_pic_2', 150)->nullable(); // Creates 'blog_pic_2' column, nullable
            $table->string('blog_pic_3', 150)->nullable(); // Creates 'blog_pic_3' column, nullable
            $table->string('blog_pic_4', 150)->nullable(); // Creates 'blog_pic_4' column, nullable
            ...
            $table->string('img_one', 255)->nullable(); // Creates 'img_one' column, nullable
