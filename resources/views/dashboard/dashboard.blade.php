            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4">
                <div class="card shadow border-0 bg-white rounded d-flex align-items-center h-100">
                    <div class="card-body d-flex align-items-center w-100">
                        ...
                        <!-- Text on the right -->
                        <div class="dash px-2">
                            <p class="icon-text mb-1">Booking</p>
                            <a href="/enquiry">
                                <h4 class="fw-semibold">{{$enquiryCount}}</h4>
                            </a>
                        </div>
                        {{-- <div class="dash px-2">
                            <p class="icon-text mb-1">Enquiry</p>
                            <a href="/home-enquiry">
                                <h4 class="fw-semibold">{{$enquiryHomeCount}}</h4>
                            </a>
                        </div> --}}
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4">
                <div class="card shadow border-0 bg-white rounded d-flex align-items-center h-100 ">
                    <div class="card-body d-flex align-items-center w-100">
                        <!-- Icon on the left -->
                        <div class="px-2">
                            <a href="/home-enquiry"> <img src="/assets/image/dashboard/innerpece_dashboard_listing_icon.svg" alt="" class="img-fluid" style="height: 60px;" />
                            </a>
                            <!-- <img src="/assets/image/dashboard/innerpece_dashboard_review_icon.svg" alt="" class="img-fluid" style="height: 60px;" /> -->
                        </div>
                        <!-- Text on the right -->
