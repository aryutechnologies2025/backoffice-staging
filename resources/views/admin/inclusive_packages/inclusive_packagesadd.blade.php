    ...
    <div class="col-lg-12">
        ...
        <div class="form-body px-4 mb-5 ms-4 me-5 rounded-4">
            ...
            <form class="" id="form_valid" action="{{ route('admin.inclusive_package_insert') }}" method="POST"
                ...
                @csrf
                <!-- 1.INFORMATION -->
                <h4 class="add_head fw-bold mb-5">1. Information</h4>
                ...
                <div class="add_form row g-2 mt-4">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-body  rounded-4">
                            <h4 class="add_head fw-bold mb-3">2.Location</h4>
                            <div class="mb-1">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="form-body  rounded-4 ">
                            <h4 class="add_head fw-bold mb-3">4. Pricing</h4>
                            <div class="mb-2">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="form-body  rounded-4">
                            <h4 class="add_head fw-bold mb-4 ps-0">5. Payment Policy</h4>
                            <div id="camp-rule-container">
                                <div class="row g-2 mb-1 align-items-center camp-rule-field add_form">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-body  rounded-4">
                            <h4 class="add_head fw-bold mb-3">6.Notes <span class="text-danger">*</span></h4>
                            <div class="mb-1">
                                <div class="row g-2 mb-1">
                                    <div class="col">
                ...
                <div class="row mb-1">
                    <div class="col">
                        <div class="form-body rounded-4">
                            <h4 class="add_head fw-bold mb-2">7.Package Inclusion </h4>
                            <div class="mb-2">
                ...
                <div class="row mb-1">
                    <div class="col">
                        <div class="form-body rounded-4">
                            <h4 class="add_head fw-bold mb-2">8.Package Exclusion </h4>
                            <div class="mb-2">
                                <div class="row g-2 mb-2">
                                    <div class="col">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-body  rounded-4">
                            <h4 class="add_head fw-bold mb-3">9. Amenities</h4>
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-body rounded-4">
                            <h4 class="add_head fw-bold mb-3">10. Food and Beverages</h4>
                            <div class="d-flex flex-wrap">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-body rounded-4">
                            <h4 class="add_head fw-bold mb-3">11. Activities</h4>
                            <div class="d-flex flex-wrap">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <div class="form-body rounded-4">
                            <h4 class="add_head fw-bold mb-3">12. Safety Features</h4>
                            <div class="d-flex flex-wrap">
