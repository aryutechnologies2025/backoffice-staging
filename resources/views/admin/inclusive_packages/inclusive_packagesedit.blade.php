    ...
    <div class="col-lg-12">
        <div class="form-body px-4 mb-5 ms-4 me-5 rounded-4">
            <form id="form_valid" action="{{ route('admin.inclusive_package_update', $package_details->id) }}" method="POST"
                ...
                @csrf
                            <h4 class="add_head fw-bold mb-4">1. Information</h4>
                            ...
                            <div class="col">
                                <div class="form-body px-5 rounded-4">
                                    <h4 class="add_head fw-bold mb-2">03. Tour Planning <span class="text-danger">*</span></h4>
        ...
        <div class="form-body rounded-4">
            ...
            <div id="day-wrapper">
                ...
                <div class="row g-2 mb-2 day-block">
                    ...
                    <div class="add_form  col-md-6 mb-2">
                        <label class="form-label fw-bold">Activity Description <span class="text-danger">*</span></label>
...
<div class="row mb-0">
    <div class="col">
        <div class="form-body rounded-4">
            <h4 class="add_head fw-bold mb-3">4. Payment Policy <span class="text-danger">*</span></h4>
            <div class="mb-3">
...
<div class="row mb-3">
    <div class="col">
        <div class="form-body px-1 py-3 rounded-4">
            <h4 class="add_head fw-bold mb-3">5. Notes <span class="text-danger">*</span></h4>
            <div>
...
<div class="row mb-3">
    <div class="col">
        <div class="form-body px-1 py-3 rounded-4">
            <h4 class="add_head fw-bold mb-3">6. Program Inclusion</h4>
            <div>
...
<div class="row mb-3">
    <div class="col">
        <div class="form-body px-1 py-3 rounded-4">
            <h4 class="add_head fw-bold mb-3">7. Program Exclusion</h4>
            <div>
...
<div class="row mb-3">
    <div class="col">
        <div class="form-body px-2 py-3 rounded-4">
            <h4 class="add_head fw-bold mb-3">8. Amenities</h4>
...
<div class="row mb-3">
    <div class="col">
        <div class="form-body px-2 py-3 rounded-4">
            <h4 class="add_head fw-bold mb-3">9. Food & Beverages</h4>
