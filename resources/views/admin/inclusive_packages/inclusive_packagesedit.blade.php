...
<div class="container-wrapper pt-5">
    <div class="row">
        <div class="col-lg-12">
            <b><a href="/dashboard">Dashboard</a> > <a href="/all-inclusive-package">Program</a> > <a class="edit">Edit</a></b>
            <br>
            <br>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class=" mt-2">
                                                <div class="row">
                                                    <div class="col-lg-12 ">
                                                        @php
                                                        $plain_text_description = strip_tags($package_details->program_description);
                                                        @endphp
                                                        <div id="summernote1">{{$plain_text_description}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-input">
                                            <label for="file-ip-100" class="px-4 py-3 text-center">
                                                ...
                                                <img id="file-ip-100-preview" src="{{ asset($package_details->cover_img) }}" alt="Cover Image" class="text-center mt-3" style="max-width: 100px; max-height: 100px; object-fit: cover;">
                                                @else
                                                <img id="file-ip-100-preview" src="/assets/image/dashboard/innerpece_addpic_icon.svg" alt="Add Pic" class="text-center mt-3">
                                                @endif
                                                <p class="text-center fw-light mt-3">Add Pic</p>
                                            </label>
                                            <input type="file" id="file-ip-100" name="cover_img" value="{{ old('cover_img') }}" accept="image/png, image/jpeg, image/svg+xml" onchange="previewImage(event)">
            ...
            <div class="row mb-4">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 mb-2">
                        <div class="form-check d-flex  align-items-center">
                            <input type="checkbox" class="me-1" id="address-{{ $address->id }}" name="address_services[]" value="{{ $address->id }}" @if(in_array((string) $address->id, $selectedAddress)) checked @endif>
