                                            ...
                                            <label for="file-ip-1" class="d-block pt-4">
                                                @if ($package_details->cover_img)
                                                    <img id="file-ip-1-preview"
                                                        src="{{ asset($package_details->cover_img) }}" alt="Cover Image"
                                                        class="rounded-3 shadow-sm"
                                                        style="max-width: 250px; max-height: 250px; object-fit: cover;">
                                                @else
                                                    <img id="file-ip-100-preview"
                                                        src="/assets/image/dashboard/innerpece_addpic_icon.svg"
                                                        alt="Add Pic" class="rounded-3 shadow-sm"
                                                        style="max-width: 250px; max-height: 250px;">
                                                @endif
                                                <p class="mt-2 text-center">Add Pic</p>
                                            </label>
                                            <input type="file" id="file-ip-1" name="cover_img"
                                                class="form-control d-none" accept="image/png, image/jpeg, image/svg+xml">
                                        ...
                                        <div class=" py-2">
                                            <div class="d-flex flex-column align-items-start gap-4">
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <input type="text" placeholder="Rename the Photo"
                                                        id="upload_image_name" name="upload_image_name"
                                                        value="{{ $package_details->upload_image_name }}"
                                                        class="form-control px-8 py-2 rounded-3 shadow-sm">
                                                </div>
                                                <div class="d-flex flex-column align-items-start">
                                                    <label class="fw-bold">Alternate Image Name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" placeholder="Alternate Name"
                                                        id="alternate_image_name" name="alternate_image_name"
                                                        value="{{ $package_details->alternate_name }}"
                                                        class="form-control px-8 py-2 rounded-3 shadow-sm">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <input type="text" id="country" name="country" class="form-control py-2 rounded-3 shadow-sm"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    <textarea class="form-control rounded-3 shadow-sm " id="location" name="location">{{ $package_details->location }}</textarea>
                                </div>
                                                ...
                                                <div class="plan-item">
                                                    ...
                                                    <div class="row g-2 mt-3 align-items-center mb-2">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            @php
                                                                $plain_text_plan_description = html_entity_decode(
                                                                    strip_tags(
                                                                        $tourPlanning['plan_description'][$index],
                                                                    ),
                                                                );
                                                            @endphp
                                                            <div class="mt-2">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div id="summernote3">
                                                                            {{ $plain_text_plan_description }}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="mb-2">
                                            <div class="row g-2 mb-2">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <label class="fw-bold mb-3">Start Date <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" class="form-control py-2 rounded-3 shadow-sm"
                                                        name="start_date" id="start_date"
                                                        value="{{ $package_details->start_date }}">
                                                </div>

                                                <!-- Return Date -->
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <label class="fw-bold mb-3">Return Date <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" class="form-control py-2 rounded-3 shadow-sm"
                                                        name="return_date" value="{{ $package_details->return_date }}"
                                                        id="return_date">
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    ...
                                                    <input type="number" class="form-control py-2 rounded-3 shadow-sm"
                                                        ...
                                                        value="{{ $package_details->total_days }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row g-2 align-items-end">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" class="form-control py-2 rounded-3 shadow-sm"
                                                        ...
                                                        value="{{ $package_details->total_room }}">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="fw-bold mb-2">Bath Rooms<span
                                                            class="text-danger"></span></label>
                                                    <input type="number" class="form-control py-2 rounded-3 shadow-sm"
                                                        name="bath_room" id="bath_room"
                                                        value="{{ $package_details->bath_room }}">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="fw-bold mb-2">Bed Rooms</label>
                                                    <input type="number" class="form-control py-2 rounded-3 shadow-sm"
                                                        id="bed_room" name="bed_room"
                                                        value="{{ $package_details->bed_room }}">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="fw-bold mb-2">Hall</label>
                                                    <input type="number" class="form-control py-2 rounded-3 shadow-sm"
                                                        id="hall" name="hall"
                                                        value="{{ $package_details->hall }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="form-body px-5  rounded-4 ">
                                        ...
                                        <div class="mb-2">
                                            <div class="row mb-2">
                                                <div class="col-lg-3">
                                                    <label class="fw-bold mb-2 ">Member Capacity <span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" id="member_capacity" name="member_capacity"
                                                        class="form-control py-2 rounded-3 shadow-sm mb-2"
                                                        placeholder="Member Capacity"
                                                        value="{{ $package_details->member_capacity }}">
                                                </div>
                                                <div class="col-lg-3">
                                                    <label class="fw-bold mb-2 ">Sprit Amount <span
                                                            class="text-danger">*</span></label>
                                                    <select id="mem_type" name="mem_type"
                                                        class="form-select py-2 rounded-3 shadow-sm mb-2">
                                                        <option value="">Select</option>
                                                        <option value="perhead"
                                                            {{ $package_details->member_type == 'perhead' ? 'selected' : '' }}>
                                                            Perhead</option>
                                                        <option value="full"
                                                            {{ $package_details->member_type == 'full' ? 'selected' : '' }}>
                                                            Full
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <input type="number" id="actual_price" name="actual_price"
                                                            ...
                                                            value="{{ $package_details->actual_price }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-body px-1 py-3 rounded-4">
                                        ...
                                        <div>
                                            <div class="row align-items-start">
                                                <!-- Google Map Input -->
                                                <div class="col-lg-6">
                                                    <label for="google_map" class="fw-bold mb-3">Google Map<span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <iframe id="map_preview" width="100%" height="250"
                                ...
                                <div class="col">
                                    <div class="form-body px-5 rounded-4 shadow-sm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="program_pdf" name="program_pdf"
                                                class="form-control py-2 rounded-3 shadow-sm" accept="application/pdf"
                                                value="{{ $package_details->program_pdf }}">
                                            @if (!empty($package_details->program_pdf))
                                                <a href="{{ asset($package_details->program_pdf) }}" target="_blank"
                                    ...
                                    <div class="form-body px-1 py-3 rounded-4">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col">
                                                ...
                                                @php
                                                    $plain_text_break_fast = html_entity_decode(
                                                        strip_tags($package_details->break_fast),
                                                    );
                                                @endphp
                                                <div class="mt-3">
                                            ...
                                            <div class="col">
                                                ...
                                                @php
                                                    $plain_text_lunch = html_entity_decode(
                                                        strip_tags($package_details->lunch),
                                                    );
                                                @endphp
                                                <div class="mt-3">
                                            ...
                                            <div class="col">
                                                ...
                                                @php
                                                    $plain_text_dinner = html_entity_decode(
                                                        strip_tags($package_details->dinner),
                                                    );
                                                @endphp
                                                <div class="mt-3">
