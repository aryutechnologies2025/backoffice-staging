                            ...
                            <div class="row d-flex mb-4">
                                <div class="col-lg-2">
                                    <div class="form-input">
                                        ...
                                        <input type="file" id="file-ip-100" name="cover_img" accept="image/png, image/jpeg, image/svg+xml" onchange="previewImage(event)">
                ...
                <div class="form-body px-5 rounded-4 m-auto">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 mb-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="address-{{ $address->id }}" name="address_services[]" value="{{ $address->id }}" @if(in_array((string) $address->id, $selectedAddress)) checked @endif>
                ...
                <div class="form-body px-5 rounded-4 m-auto">
                    ...
                    <div id="plan-container">
                        ...
                        <div class="row g-2 mt-5 d-flex justify-content-around">
                                <div class="col-lg-12">
                                    <input type="text" name="plan_title[]" class="form-control py-3 rounded-3 shadow-sm" placeholder="Plan Title" required value="{{ isset($tourPlanning['plan_title'][$index]) ? $tourPlanning['plan_title'][$index] : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="mt-5">
                                <div class="row">
                                    <div class="col-lg-11">
                                        ...
                                        <input type="text" name="plan_subtitle[]" class="form-control py-3 rounded-3 shadow-sm" placeholder="Plan Subtitle" required value="{{ $tourPlanning['plan_subtitle'][$index] }}">
                                    </div>
