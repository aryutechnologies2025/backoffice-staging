...
<div class="row body-sec py-5 px-5 justify-content-around">
    <div class="">
        ...
        <br><br>
        <h3 class="fw-bold">Edit Stay Districts</h3>
    </div>
</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.staydistrict_update', $destination->id) }}" enctype="multipart/form-data" id="districts-form">
                    ...
                    <div class="d-flex justify-content-between my-4">
                        ...
                        <div>
                            <a href="{{ route('admin.staydistrictlist') }}" class="btn btn-outline-secondary me-2">Cancel</a>
...
<script>
    $(document).ready(function() {
        ...
        let districtCount = {{ count($destination->districts_data) }};
