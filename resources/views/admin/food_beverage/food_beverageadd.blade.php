                    ...
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Food&Beverage" id="food_beverage" name="food_beverage" class="form-control py-3 rounded-3 shadow-sm" required value="{{old('food_beverage')}}">
                            </div>
                        </div>
                        <div class="g-2 mb-4">
                            <div class="col">
