...
<div class="row mb-5">
    <div class="col-lg-12">
        ...
        <div class="form-body px-4 mb-5 ms-4 me-5 rounded-4">
            <form id="form_valid" action="{{ route('admin.mailtemplateupdate', ['id'=>$template->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    <div class="row gap-2">
                        ...
                        <div class="add_form col-md-4 ">
                            ...
                            <input type="text" placeholder="Title" id="title" name="title" value="{{$template->title}}" class="form-control py-2 rounded-3 shadow-sm" required>
                        </div>
                        <div class="g-2 mb-2">
                            <div class="add_form col">

                                <label class=" fw-bold mb-2" id="label_textarea"> Email Template<span class="text-danger">*</span></label>
                                <input type="hidden" id="email_template" name="email_template" value="{{ old('email_template', strip_tags($template->mail_template)) }}">
                                <div class=" mt-2">
                                    <div class="row">
                                        <div class="col-lg-10 ">
                                            <div id="summernote" style="height: 200px;">{!! $template->mail_template !!}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row g-2">
                    <div class="add_form col">
                        ...
                        <div class="form-check form-switch d-flex align-items-center">
                             <input class="form-check-input check_bx" type="checkbox" id="status" name="status" {{ old('status', $template->status) ? 'checked' : '' }}>
                        </div>
                    </div>
                </div>
