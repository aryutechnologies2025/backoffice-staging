                    ...
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Safety Features" id="safety_features" name="safety_features" class="form-control py-3 rounded-3 shadow-sm" required value="{{ $safety_feature_details->safety_features }}">
                            </div>
                        </div>
                        <div class="g-2 mb-4">
                            <div class="col">
