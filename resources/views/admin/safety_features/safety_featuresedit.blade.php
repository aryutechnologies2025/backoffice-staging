                                ...
                                <div class="row d-flex mb-4">
                                    <div class="col-lg-2">
                                        <div class="form-input"> -->
                                            ...
                                            <img id="file-ip-1-preview" src="{{ asset($safety_feature_details->safety_features_pic) }}"   alt="{{$safety_feature_details->alternate_name}}" class="img-thumbnail mb-3" style="max-height: 150px; object-fit: cover;">
                                            @else
                                            <img id="file-ip-1-preview" src="/assets/image/dashboard/innerpece_addpic_icon.svg"   alt="{{$safety_feature_details->alternate_name}}" class="img-thumbnail mb-3">
                                            @endif
