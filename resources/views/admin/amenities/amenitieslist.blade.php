        ...
        <div class="table-sec rounded-bottom-4 shadow-sm mb-5">
                ...
                <tbody>
                    ...
                    <td class="text-center"><img src="{{ asset($row->amenity_pic) }}" alt="Thumbnail" style="max-width: 100px; max-height: 100px; object-fit: cover;"></td>
                        ...
                        <td class="text-center" style="width: 20%;">
                            ...
                            <a href="javascript:void(0);" class="table-link danger delconfirm" data-row_id="{{ $row->id }}" data-act_url="{{ route('admin.amenities_delete') }}" data-csrf_token="{{ csrf_token() }}">
                                <span class="fa-stack">
                                    <i class="fa fa-square fa-stack-2x"></i>
            ...
            <div class="pagination-sec">
                <ul class="pagination justify-content-center">
                    ...
                    @else
                    <li class="page-item">
                        <a class="page-link rounded-circle text-dark fw-bold" href="{{ $amenities->previousPageUrl() }}" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </li>
                    @endif
                    <!-- Page Number Links -->
                    @foreach ($amenities->links()->elements[0] as $page => $url)
                    <li class="page-item {{ $page == $amenities->currentPage() ? 'active' : '' }}">
                    ...
                    <li class="page-item">
                        <a class="page-link rounded-circle text-dark fw-bold ms-2" href="{{ $amenities->nextPageUrl() }}" aria-label="Next">
