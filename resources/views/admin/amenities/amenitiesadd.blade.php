...
<div class="row mb-5">
    <div class="col-lg-12">
        <div class="form-body px-4 mb-5 rounded-4">
            <form id="form_valid" action="{{ route('admin.amenities_insert') }}" method="POST" autocomplete="off"
                ...
                <div class="row g-2 mb-4">
                    <div class="col">
                        ...
                        <input type="text" placeholder="Amenity" id="amenity_name" name="amenity_name"
                            class="form-control py-2 rounded-3 shadow-sm" required value="{{old('amenity_name')}}">
                    </div>
