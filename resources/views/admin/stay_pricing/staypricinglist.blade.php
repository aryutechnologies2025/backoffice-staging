...
<div class="row body-sec py-5 px-5 justify-content-around">
    <div class="col-lg-6">
    <b><a href="/dashboard" >Dashboard</a> > <a class="city" href="" >Stay Pricing</a></b>
        <br>
        <br>
    ...
    <div class="col-lg-6">
        <div class="d-flex justify-content-end">
            <a href="{{ route('admin.staypricing_add_form') }}">
                <button class="btn btn-add px-5" type="button">Add Stay Pricing</button>
            </a>
        </div>
    </div>
</div>
            ...
            <table id="cityTable" class="table pt-2">
                <thead>
                    ...
                    <tr>
                        ...
                        @endphp
                        <td class="text-center"><a data-toggle="tooltip" data-csrf_token="{{ csrf_token() }}" data-original-title="{{ $actTitle }}" class="stsconfirm" href="javascript:void(0);" data-row_id="{{ $row->id }}" data-act_url="{{ route('admin.staypricing_change_status') }}" data-stsmode="{{ $mode }}"><button type="button" class="btn {{ $btnColr }} px-5">{{ $disp_status }}</button></a></td>
