...
<div class="container-wrapper pt-5">
    <div class="row">
            <!-- <div class="col-lg-12"> -->
    <b><a href="/dashboard" >Dashboard</a> > <a href="/activities" >Activities</a> > <a class="add" >Add</a></b>
        <br>
        <br>
    ...
    <div class="row mb-5">
        <div class="col-lg-12">
            <div class="form-body px-4 mb-5 rounded-4">
                <form id="form_valid" action="{{ route('admin.activities_insert') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <!-- <label class="fw-bold mt-4"> Activities Logo </label>
                    ...
                    <input type="text" placeholder="Alternate Name" id="alternate_image_name" name="alternate_image_name" value="{{ old('alternate_image_name') }}" class="form-control py-2 rounded-3 shadow-sm" required>
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Activities" id="activities" name="activities" class="form-control py-2 rounded-3 shadow-sm" required value="{{old('activities')}}">
                            </div>
