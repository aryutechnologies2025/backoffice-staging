...
@section('content')
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4">
            <strong><label for="program_title" class="form-label">Program Title:
            </strong>{{ $enquiry->program_title ?? 'null' }}</label>
        </div>
        <div class="col-md-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_valid" method="POST" action="{{ route('admin.enquiry.addFollowUp', $enquiry->id) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <strong><label class="form-label">Follow-up Date <span
                            ...
                            <div class="col-md-6">
                                <strong><label for="lead_source" class="form-label">Lead Source <span
                                            class="text-danger">*</span></label></strong>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <strong><label for="lead_status" class="form-label">Lead Status <span
                                            class="text-danger">*</span></label></strong>
                            ...
                            <div class="col-md-6">
                                <strong><label for="follow_up_notes" class="form-label">Follow-up Notes <span
                                            class="text-danger">*</span></label></strong>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <strong><label for="deal_value" class="form-label">Deal Value <span
                                            class="text-danger">*</span></label></strong>
                                <input type="number" step="0.01" id="deal_value" name="deal_value"
                                    class="form-control">
                            </div>
                            <div class="col-md-6">
                                <strong><label for="assigned_to" class="form-label">Assigned To <span
                                            class="text-danger">*</span></label></strong>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <strong><label for="next_follow_up_date" class="form-label">Next FollowUp Date <span
                                            class="text-danger">*</span></label></strong>
    ...
    <div class="col-lg-12">
        <strong>
            <div class="d-flex justify-content-end mt-3 mr-3">
                <p class="text-danger justify-content-end"><span
                        class="fw-bold text-black ">Status:</span>{{ $enquiry->followup }}</p>
            </div>
        </strong>
    </div>
