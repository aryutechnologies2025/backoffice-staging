    ...
    <div class="row mb-5">
        <div class="col">
            ...
            <div class="form-body px-5 py-5 rounded-4 m-auto ">
                <form id="form_valid" action="{{ route('admin.geo_feature_insert') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col">
                                <label class="fw-bold mb-4 ">Geo feature Name <span class="text-danger">*</span></label>
                                <input type="text" placeholder="Geo" id="geo_feature" name="geo_feature" value="{{old('geo_feature')}}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        <div class="g-2 mb-4">
                            <div class="col">
