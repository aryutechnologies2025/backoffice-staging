...
<div class="row body-sec py-5 px-5 justify-content-around">
    <div class="col-lg-12 mb-5">
        <h3 class="fw-bold"><span class="vr"></span>&nbsp;Edit Profile</h3>
    </div>
            ...
            <div class="form-body px-5 py-5 rounded-4 m-auto">
                <div class="row mb-4">
                    <div class="col-lg-6">
                        ...
                        <input type="text" id="first_name" name="first_name" class="form-control py-3 rounded-3 shadow-sm" placeholder="First Name" value="{{ old('first_name', $admin_dts->first_name) }}" required>
                    </div>
                    <div class="col-lg-6">
                        <label class="fw-bold mb-4" for="last_name">Last Name <span class="text-danger">*</span></label>
                        <input type="text" id="last_name" name="last_name" class="form-control py-3 rounded-3 shadow-sm" placeholder="Last Name" value="{{ old('last_name', $admin_dts->last_name) }}" required>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <label class="fw-bold mb-4" for="phone_number">Phone <span class="text-danger">*</span></label>
                        <input type="text" id="phone_number" name="phone_number" class="form-control py-3 rounded-3 shadow-sm" placeholder="Phone" value="{{ old('phone_number', $admin_dts->phone) }}" required>
                    </div>
                    <div class="col-lg-6">
                        <label class="fw-bold mb-4" for="email">Email <span class="text-danger">*</span></label>
                        <input type="email" id="email" name="email" class="form-control py-3 rounded-3 shadow-sm" placeholder="Email" value="{{ old('email', $admin_dts->email) }}" required>
                    </div>
                </div>
            </div>
