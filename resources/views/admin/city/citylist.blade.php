            ...
            <table id="cityTable" class="table pt-2">
                ...
                <tbody>
                    ...
                    <td class="text-center">{{ $loop->iteration }}</td>
                        ...
                        @endphp
                        <td class="text-center">
                            <a data-toggle="tooltip" data-csrf_token="{{ csrf_token() }}" data-original-title="{{ $actTitle }}" class="stsconfirm" href="javascript:void(0);" data-row_id="{{ $row->id }}" data-act_url="{{ route('admin.city_status') }}" data-stsmode="{{ $mode }}">
