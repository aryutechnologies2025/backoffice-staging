                    ...
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            ...
                            <div class="col">
                                ...
                                <input type="text" placeholder="City Name" id="city_name" name="city_name" class="form-control py-3 rounded-3 shadow-sm" value="{{ $city_details->city_name }}" required>
                            </div>
                        </div>
                        <div class="g-2 mb-4">
                            <div class="col">
                                ...
                                <div class="row d-flex mb-4">
                                    <div class="col-lg-2">
                                        <div class="form-input">
                                            ...
                                            <img id="file-ip-1-preview" src="{{ asset($city_details->cities_pic) }}" alt="Thumbnail Preview" class="img-thumbnail mb-3" style="max-height: 150px; object-fit: cover;">
                                            @else
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Order" id="list_order" name="list_order" value="{{ $city_details->list_order }}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        <div class="row g-2">
                            <div class="col">
