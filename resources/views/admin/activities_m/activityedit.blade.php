...
<div class="row body-sec py-3 px-5 justify-content-around">
    <div class="text-start col-lg-6 ">
        <h3 class="admin-title fw-bold">Edit Activity</h3>
    </div>
...
<div class="row mb-5">
    <div class="col-lg-12">
        <div class="form-body px-4 mb-5 ms-4 me-5 rounded-4">
            <form class="" id="form_valid" action="{{ route('admin.activity_update', $destination_details->id) }}" method="POST" autocomplete="off"
        ...
        <script>
            ...
            // let fieldCounter = {
            //     {
            //         count($camp_rules ?? []) > 0 ? count($camp_rules) - 1 : 0
            //     }
            // };
