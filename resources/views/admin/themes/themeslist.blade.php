        ...
        <table id="cityTable" class="table pt-2">                
            <thead>
                ...
                <tbody>
                    ...
                    <td class="text-center"><img src="{{ $row->theme_pic ? asset($row->theme_pic) : asset($settings->footer_logo) }}"  alt="{{ $row->alternate_name ?? 'Default Alt Text' }}" style="max-width: 100px; max-height: 100px; object-fit: cover;"></td>
