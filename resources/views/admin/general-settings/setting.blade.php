            ...
            <div class="form-body px-5 py-5 rounded-4">
                <div class="row mb-2">
                    <div class="add_form col-lg-6">
                        <label class="add-form fw-bold mb-2 ">Meta Title <span class="text-danger">*</span></label>
                    ...
                    <div class="add_form col-lg-6">
                        <label class="fw-bold mb-2">Meta Keywords <span class="text-danger">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="add_form col-lg-6">
                        <label class="fw-bold mb-2">Meta Description <span class="text-danger">*</span></label>
                ...
                <div class="row g-2">
                    <div class="add_form col-lg-3">
                        <label class="fw-bold mt-4 mb-2"> Site Logo </label>
                    ...
                    <div class="add_form col-lg-3">
                        <label class="fw-bold mt-4 mb-2"> Footer Logo </label>
                        <div class="form-input text-center mb-4">
                    ...
                    <div class="add_form col-lg-3">
                        <label class="fw-bold mt-4 mb-2"> Footer Official Logo </label>
                        <div class="form-input text-center mb-4">
                    ...
                    <div class="add_form col-lg-3">
                        <label class="fw-bold mt-4 mb-2"> Favicon </label>
                        <div class="form-input text-center mb-4">
