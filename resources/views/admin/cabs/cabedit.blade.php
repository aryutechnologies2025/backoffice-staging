...
<div class="row body-sec py-3 px-5 justify-content-around">
    <div class="text-start col-lg-6 ">
        <h3 class="admin-title fw-bold">Edit Cab </h3>
    </div>
    ...
    <div class="col-lg-12">
        <div class="form-body px-4 mb-5 ms-4 me-5 rounded-4">
            <form class="" id="form_valid" action="{{ route('admin.cab_update', $destination_details->id) }}" method="POST" autocomplete="off"
                ...
                @csrf
                            <h4 class="add_form fw-bold mb-3">Information</h4>
                                        ...
                                        <div id="camp-rule-container">
                                            ...
                                            <div class="camp-rule-field mb-4 p-3 border rounded">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="add_form mb-2">Price <span class="text-danger">*</span></label>
                                                        <input type="text" placeholder="Price"
