    ...
    <div class="col-lg-6">
        <div class="d-flex justify-content-end">
            <a href="{{ route('admin.cab_add_form') }}">
                <button class="btn btn-add px-5" type="button">Add Cab</button>
            </a>
        </div>
    </div>
</div>
            ...
            <table id="cityTable" class="table pt-2">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $row->travel_mode }}</td>
                        @php
                        ...
                        @endphp
                        <td class="text-center"><a data-toggle="tooltip" data-csrf_token="{{ csrf_token() }}" data-original-title="{{ $actTitle }}" class="stsconfirm" href="javascript:void(0);" data-row_id="{{ $row->id }}" data-act_url="{{ route('admin.cab_change_status') }}" data-stsmode="{{ $mode }}"><button type="button" class="btn {{ $btnColr }} px-5">{{ $disp_status }}</button></a></td>
