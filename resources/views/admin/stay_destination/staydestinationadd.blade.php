...
<div class="row body-sec py-5  px-5 justify-content-around">
    ...
    <div class="row mb-5">
        <div class="col">
            <div class="form-bodyc py-5 rounded-4 m-auto ">
                <form id="form_valid" action="{{ route('admin.staydestination_insert') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
