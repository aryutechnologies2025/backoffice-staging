                    ...
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Destination" id="city_name" name="city_name" value="{{ $destination_details->city_name }}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Rename the Photo" id="upload_image_name" name="upload_image_name" value="{{ $destination_details->upload_image_name }}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Alternate Name" id="alternate_name" name="alternate_name" value="{{ $destination_details->alternate_name }}"  class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
