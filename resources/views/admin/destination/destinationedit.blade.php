    ...
    <div class="row mb-5">
        <div class="col">
            <div class="form-body px-5 py-5 rounded-4 m-auto ">
                <form id="form_valid" action="{{ route('admin.destination_update', ['id' => $destination_details->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col">
                                <label class="fw-bold mb-4"> Destination <span class="text-danger">*</span></label>
                                <input type="text" placeholder="Destination" id="destination_name" name="destination_name" value="{{ $destination_details->destination_name }}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        <div class="row g-2 mb-4">
                            <div class="col">
                                <label class="fw-bold mb-4 "> Place <span class="text-danger">*</span></label>
                                <input type="text" placeholder="Place" id="place" name="place" class="form-control py-3 rounded-3 shadow-sm" required value="{{ $destination_details->place }}">
                            </div>
                        </div>
                                ...
                                <div class="row d-flex mb-4">
                                    <div class="col-lg-2">
                                        <div class="form-input">
                                            ...
                                            @if ($destination_details->destination_pic)
                                            <img id="file-ip-1-preview" src="{{ asset($destination_details->destination_pic) }}" alt="Thumbnail Preview" class="img-thumbnail mb-3" style="max-height: 150px; object-fit: cover;">
                                            @else
