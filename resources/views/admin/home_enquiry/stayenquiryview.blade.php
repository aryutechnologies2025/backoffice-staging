...
<div class="row body-sec py-3 px-5 justify-content-around">
    ...
    <b><a href="/dashboard">Dashboard</a> > <a href="{{ route('admin.stay_home_enquiry_list') }}">Stay Enquiry</a> > <a class="edit">View</a></b>
            ...
            <div class="mb-3">
                ...
                <div class="row g-2  mb-4 d-flex">
                    ...
                    <div class="add_form col">
                        ...
                        <input type="Travel Destination" class="form-control"
                            name="location"
                  ...
                  <div class="row g-2  mb-4 d-flex">
                    <div class="add_form col-lg-6 pe-3">
                        <label class="fw-bold mb-2">Budget Per Head:</label>
                        <input type="Budget Per Head" class="form-control "
                            name="Budget Per Head"
                            value="{{ $user_details->budget_per_head }}"
                            readonly>
                    </div>
                </div>
