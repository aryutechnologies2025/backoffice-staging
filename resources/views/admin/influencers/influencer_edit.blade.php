            ...
            <form id="form_valid" action="{{ route('admin.influencer_update', ['id'=>$influencer->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <div class="card-header">
                        <h5 class="add_head mb-3">Personal Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="add_form col-md-3 mb-3">
                            ...
                            <div class="add_form col-md-2 mb-3">
                ...
                <div class="mb-4">
                    <div class="card-header">
                        <h5 class="add_head mb-3">{{ ucfirst($platform) }} Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="add_form col-md-3 mb-3">
