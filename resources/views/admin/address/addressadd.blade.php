                    ...
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="Title" id="title" name="title" value="{{old('title')}}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" placeholder="City" id="city" name="city" value="{{old('city')}}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        <div class="row g-2 mb-4">
                            <div class="col">
                                <label class="fw-bold mb-4 "> State <span class="text-danger">*</span></label>
                                <input type="text" placeholder="State" id="email" name="state" value="{{old('state')}}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        <div class="row g-2 mb-4">
                            <div class="col">
                                <label class="fw-bold mb-4 "> Zip/Postal Code <span class="text-danger">*</span></label>
                                <input type="text" placeholder="Zip/Postal Code" id="pincode" name="pincode"  class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col">
                                ...
                                <input type="text" id="country" placeholder="County" name="country" value="{{old('country')}}" class="form-control py-3 rounded-3 shadow-sm" required>
                            </div>
                        </div>
