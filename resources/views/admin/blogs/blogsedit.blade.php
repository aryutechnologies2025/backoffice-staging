...
<div class="row body-sec py-5 px-5 justify-content-around">
    <div class="col-lg-12">
        <h3 class="fw-bold"><span class="vr"></span>&nbsp;Edit Blog</h3>
    </div>
    ...
    <div class="row mb-5">
        <div class="col">
            ...
            <div class="form-body px-5 py-5 rounded-4 m-auto mt-5">
                <form id="form_valid" action="{{ route('admin.blog_update', $blog_details->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        <div class="row g-2 mb-4">
                            <div class="col-lg-6 mt-3">
                                <label class="fw-bold mb-4 ">Blog Title <span class="text-danger">*</span></label>
                                <input type="text" id="blog_title" name="blog_title" class="form-control py-3 rounded-3 shadow-sm" placeholder="Title" value="{{ old('blog_title', $blog_details->blog_title) }}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-5">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div id="summernote">{!! old('description', $blog_details->description) !!}</div>
                        ...
                        <div class="col-lg-2">
                            <div class="form-input">
                                <label for="file-ip-1" class="px-4 py-3 text-center">
                                    <img class="text-center mt-3" id="file-ip-1-preview" src="{{ asset('uploads/blog_pic/' . $blog_details->blog_pic_1) }}">
                                    <p class="text-center fw-light mt-3"> Add Pic</p>
                                </label>
                                <input type="file" name="img_one" id="file-ip-1" data-number="1" accept="image/*">
                            </div>
                        </div>
                        <!-- Repeat similar blocks for img_two, img_three, and img_four if needed -->
                    </div>
                    ...
                    <div class="row g-2 mt-5">
                        <div class="col">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input check_bx" type="checkbox" id="status" name="status" {{ $blog_details->status ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
