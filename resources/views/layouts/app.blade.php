    ...
    <div class="row ">
        <header class="header py-5" id="header">
            ...
            <div class="col-lg-3 text-end pt-3">
                ...
                <img class="rounded-circle" style="width: 10%; height: auto;" src="{{ session('admin_profile_pic') ? asset(session('admin_profile_pic')) : '/assets/image/dashboard/innerpece_admin_img.png' }}" alt="Admin Profile Picture">
            </div>
        ...
        <nav class="nav">
            <div>
                <div class="nav_list">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="nav_link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/Dashboard.svg" alt="">
                        <span class="nav_name">Dashboard</span>
                    </a>
                    <a href="{{ route('admin.slider_list') }}" class="nav_link {{ request()->routeIs(['admin.slider_list', 'admin.slider_add_form', 'admin.slider_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/slider.svg" alt="">
                        <span class="nav_name"> Slider </span>
                    </a>
                    <a href="{{ route('admin.themes_list') }}" class="nav_link {{ request()->routeIs(['admin.themes_list', 'admin.themes_add_form', 'admin.themes_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/themes.svg" alt="">
                        <span class="nav_name">Theme</span>
                    </a>
                    <a href="{{ route('admin.citylist') }}" class="nav_link {{ request()->routeIs(['admin.citylist', 'admin.city_add_form', 'admin.city_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/location-pin.svg" alt="">
                        <span class="nav_name"> Destination </span>
                    </a>
                    <a href="{{ route('admin.inclusive_package_list') }}" class="nav_link {{ request()->routeIs(['admin.inclusive_package_list', 'admin.inclusive_package_add_form', 'admin.inclusive_package_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/program.svg" alt="">
                        <span class="nav_name"> Programs </span>
                    </a>
                    <a href="{{ route('admin.address_list') }}" class="nav_link {{ request()->routeIs(['admin.address_list', 'admin.address_add_form', 'admin.address_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/program.svg" alt="">
                        <span class="nav_name"> Address </span>
                    </a>
                    <a href="{{ route('admin.client_review_list') }}" class="nav_link {{ request()->routeIs(['admin.client_review_list', 'admin.client_review_add_form', 'admin.client_review_edit_form']) ? 'active' : ''}} mb-3">
                        <img src="/assets/image/dashboard/review.svg" alt="">
                        <span class="nav_name"> Client Review </span>
                    </a>
                    <a href="{{ route('admin.wish_list') }}" class="nav_link {{ request()->routeIs(['admin.wish_list', 'admin.wishlist_add_form', 'admin.wishlist_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/wishlist.svg" alt="">
                        <span class="nav_name"> Wishlist</span>
                    </a>
                 
                    <a href="{{ route('admin.faqlist') }}" class="nav_link {{ request()->routeIs(['admin.faqlist', 'admin.faq_add_form', 'admin.faq_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/faq.svg" alt="">
                        <span class="nav_name">FAQ</span>
                    </a>
                   
                    <a href="{{ route('admin.amenitieslist') }}" class="nav_link {{ request()->routeIs(['admin.amenitieslist', 'admin.amenities_add_form', 'admin.amenities_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/amenities.svg" alt="">
                        <span class="nav_name">Amenities</span>
                    </a>
                    <a href="{{ route('admin.food_beveragelist') }}" class="nav_link {{ request()->routeIs(['admin.food_beveragelist', 'admin.food_beverage_add_form', 'admin.food_beverage_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/fast-food.svg" alt="">
                        <span class="nav_name">Food&Beverage</span>
                    </a>
                    <a href="{{ route('admin.activitieslist') }}" class="nav_link {{ request()->routeIs(['admin.activitieslist', 'admin.activities_add_form', 'admin.activities_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/activities.svg" alt="">
                        <span class="nav_name">Activities</span>
                    </a>
                    <a href="{{ route('admin.safety_features_list') }}" class="nav_link {{ request()->routeIs(['admin.safety_features_list', 'admin.safety_features_add_form', 'admin.safety_features_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/security.svg" alt="">
                        <span class="nav_name">Safety Features</span>
                    </a>
                    {{--
                    <a href="{{ route('admin.group_tour_list') }}" class="nav_link {{ request()->routeIs(['admin.group_tour_list', 'admin.group_tour_add_form', 'admin.group_tour_edit_form']) ? 'active' : '' }} mb-3">
                    <img src="/assets/image/dashboard/program.svg" alt="">
                    <span class="nav_name"> Group Tour Packages </span>
                    </a>
                    <a href="{{ route('admin.destination_cat_list') }}" class="nav_link {{ request()->routeIs(['admin.destination_cat_list', 'admin.destination_cat_add_form', 'admin.destination_cat_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/destination_cat.svg" alt="">
                        <span class="nav_name"> Destination Category</span>
                    </a>
                    <a href="{{ route('admin.themes_cat_list') }}" class="nav_link {{ request()->routeIs(['admin.themes_cat_list', 'admin.themes_cat_add_form', 'admin.themes_cat_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/theme_cat.svg" alt="">
                        <span class="nav_name">Theme Category</span>
                    </a>
                    <a href="{{ route('admin.podcastlist') }}" class="nav_link {{ request()->routeIs(['admin.podcastlist', 'admin.podcast_add_form', 'admin.podcast_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/microphone.svg" alt="">
                        <span class="nav_name"> Podcast</span>
                    </a>
                    <a href="{{ route('admin.geo_feature_list') }}" class="nav_link {{ request()->routeIs(['admin.geo_feature_list', 'admin.geo_feature_add_form', 'admin.geo_feature_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/earth-globe.svg" alt="">
                        <span class="nav_name">Geo Features</span>
                    </a>
                    <a href="{{ route('admin.blog_list') }}" class="nav_link {{ request()->routeIs(['admin.blog_list', 'admin.blog_add_form', 'admin.blog_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/blog.svg" alt="">
                        <span class="nav_name"> Blog </span>
                    </a>
                    <a href="{{ route('admin.destinationlist') }}" class="nav_link {{ request()->routeIs(['admin.destinationlist', 'admin.destination_add_form', 'admin.destination_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/location-pin.svg" alt="">
                    ...
                    <a href="{{ route('admin.property_list') }}" class="nav_link {{ request()->routeIs(['admin.property_list', 'admin.property_add_form', 'admin.property_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/innerpece_eventlist_icon.svg" alt="">
                    ...
                    <a href="{{ route('admin.eventList') }}" class="nav_link {{ request()->routeIs(['admin.eventList', 'admin.event_add_form', 'admin.company_edit_form']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/innerpece_eventlist_icon.svg" alt="">
                    ...
                    <a href="{{ route('admin.user_list') }}" class="nav_link {{ request()->routeIs(['admin.user_list', 'admin.user_add_form', 'admin.user_edit_form']) ? 'active' : ''}} mb-3">
                        <img src="/assets/image/dashboard/user.svg" alt="">
                        <span class="nav_name"> User Registration </span>
                    </a>
                    <a href="{{ route('admin.contact_list') }}" class="nav_link {{ request()->routeIs(['admin.contact_list']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/contact-us.svg" alt="">
                        <span class="nav_name">contact-Us</span>
                    </a>
                    <a href="{{ route('admin.enquiry_list') }}" class="nav_link {{ request()->routeIs(['admin.enquiry_list']) ? 'active' : '' }} mb-3">
                        <img src="/assets/image/dashboard/enquiry.svg" alt="">
                        <span class="nav_name"> Enquiries </span>
                    </a>
                    <a href="{{ route('admin.profile_list') }}" class="nav_link {{ request()->routeIs(['admin.profile_list', 'admin.profile_add_form', 'admin.profile_edit_form']) ? 'active' : '' }} mb-3">
